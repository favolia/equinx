        ...
        <>
            <main className='w-full'>
                <header className='header-anchor w-full h-screen flex lg:flex flex-col justify-between bg-[url(/assets/images/Hero.jpg)] bg-cover bg-left lg:bg-center pt-4'>
                    ...
                    <Navbar iconColor={'text-[#6F5730]'} background={`text-charcoal bg-white/5 backdrop-blur-2xl`} padding={`px-3 lg:px-4`} />
                    <NavbarMobile withMenu logoColor='text-[#6F5730]' style={'text-white backdrop-blur-2xl rounded-small py-2 bg-white/5 px-5'} paddingWhenScroll='pt-3' padding='px-3' />
